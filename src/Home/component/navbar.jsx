    ...
    <nav className="fixed top-0 left-0 h-full z-50 bg-black text-white px-4 md:px-3 lg:px-5 py-3 shadow-md">
      <div className="flex flex-col h-full items-center">
        ...
        <div className="space-y-4 text-sm font-medium flex-col">
          ...
          <NavLink to="/project" end className={({ isActive }) => `transition flex items-center gap-4 rounded-lg px-5 py-2 text-sm ${isActive ? "bg-blue-400 text-white" : "hover:bg-blue-300 hover:text-white"}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
          ...
          <NavLink to="/article" end className={({ isActive }) => `transition flex items-center gap-4 rounded-lg px-5 py-2 text-sm ${isActive ? "bg-blue-400 text-white" : "hover:bg-blue-300 hover:text-white"}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
