                  ...
                  <div className="p-3 bg-purple-300 min-h-[5rem] w-full">
                    <div className="bg-white shadow-xl p-3 rounded-lg grid grid-cols-7">
                      ...
                      <div className="col-span-5">
                        ...
                        {/* <p className="text-sm"> {Article.attributes.body.split(" ").slice(0, 3).join(" ") ?? ""}...</p> */}
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-2 col-span-2 ">
                        <div className="col-span-1 flex justify-end">
                          <button onClick={() => handleDetail(Article)} className="bg-blue-400 hover:bg-blue-500 shadow-xl rounded-2xl h-[3rem] w-[3rem] flex items-center justify-center">
                        ...
                        <div className="col-span-1 flex justify-end">
                          <button onClick={() => handleDelete(Article.id)} className="bg-red-400 hover:bg-red-500 shadow-xl rounded-2xl h-[3rem] w-[3rem] flex items-center justify-center">
        ...
        <div className="bg-white w-full max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-2xl p-4 sm:p-6 rounded-2xl shadow-xl space-y-4 overflow-y-auto max-h-screen relative text-sm text-black">
          <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">{isEdit ? "Edit Article" : "Add New Article"}</h1>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 px-4">
              <input type="text" placeholder="Article Name" value={formData.name} onChange={(e) => handleChange("name", e.target.value)} className="border border-gray-300 mb-8 rounded-xl px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-400" required />
