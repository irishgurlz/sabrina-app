...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchLandingPageData = async () => {
      axios
        .get(`https://api.kyuib.my.id/api/v1/landing-pages/1`)
        .then((res) => {
    ...
    <section className="px-8 py-6">
      <div className="flex flex-col gap-6">
        <div className="w-full bg-gradient-to-r from-blue-400 via-blue-300 to-blue-400 rounded-2xl p-6 text-white shadow-md flex justify-between items-center">
          ...
          <div className="bg-slate-300 rounded-full p-7 bg-cover bg-center shadow-lg" style={{ backgroundImage: `url(${dataUser?.attributes?.about_me_image_url})`, }}>
